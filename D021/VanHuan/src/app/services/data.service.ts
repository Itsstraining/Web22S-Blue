...
export class DataService {
  ...
  public collet=collection(this.firestore,"listgame")
  constructor(public firestore:Firestore) {
    // let collet=collection(firestore,"listgame")
    collectionData(this.collet,{idField:'id'}).subscribe((data)=>{
      this.listGame=data;
    })
   }
    // constructor(public firestore:Firestore) {}
    // public pushAutoData(){
    //      let collet=collection(this.firestore,"listgame");
    //      for( let item of this.listGame){
    //        addDoc(collet,item);
    //      }
    // }
}
